...
usage() {
  ...
  echo "  check-userset-small  Run small userset scenario (50-100 groups/doc, 3 rate tiers)"
  echo "  check-userset-scale  Run high userset fan-out scenario (100-1000 groups/doc)"
...
case $SCENARIO in
    ...
    check)
        ...
        run_scenario "check-userset-scale" "check-userset-scale.js"
        ;;
    check-direct)
        run_scenario "check-direct" "check-direct.js"
        ;;
    ...
    check-precompute)
        ...
        ;;
    check-userset-small)
        run_scenario "check-userset-small" "check-userset-small.js"
        ;;
    check-userset-scale)
        run_scenario "check-userset-scale" "check-userset-scale.js"
        ;;
